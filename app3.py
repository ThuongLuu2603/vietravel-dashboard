...
# HÀNG 4: NHÂN SỰ
# ==============================================================================
st.markdown('<div class="header-style">5. NHÂN SỰ (HUMAN CAPITAL)</div>', unsafe_allow_html=True)
bot_1, bot_2, bot_3 = st.columns(3)

with bot_1:
    st.markdown('**Năng suất: Lợi nhuận/NS**')
    data_hr_bar = { "Năm": ["2023", "2024", "2025"] * 5, "Đơn vị": sorted(["Toàn Cty", "HO & ĐNB", "Miền Bắc", "Miền Trung", "Miền Tây"] * 3), "Lợi nhuận/NS": [180, 200, 220, 200, 230, 250, 150, 170, 190, 160, 180, 200, 120, 130, 140] }
    df_hr_bar = pd.DataFrame(data_hr_bar)
    fig_hr = px.bar(df_hr_bar, x="Năm", y="Lợi nhuận/NS", color="Đơn vị", barmode='group', text_auto=True, color_discrete_map=COLOR_MAP)
